		...
		<div class="container">
			...
			<div class="su_title"> 신규 회원가입 </div>
				...
				<form action="" method="post">
					...
					<!-- 비밀번호 -->
					<div class="form-floating mb-3">
						<input type="password" class="form-control" id="user_pw" name="user_pw" onkeyup="pw_check1()" placeholder="Password">
					...
					<!-- 비밀번호확인 -->
					<div class="form-floating mb-3">
						<input type="password" class="form-control" id="user_pw_confirm" name="user_pw_confirm" placeholder="Password Check">
						<label for="user_pw_confirm"> Password Check </label>
						<div class="check_icon5">  </div>
					</div>
						
					<div class="btn_box">
						<button class="sign_up_btn" onclick="sign_up()"> 회원가입 </button>
					</div>
